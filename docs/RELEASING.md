...
`gotth-media` versions independently under Semantic Versioning. A version number in
...
5. Verify exact head and tag parity at
   `github.com/gotthboard/gotth-media` through the existing one-way push mirror.
